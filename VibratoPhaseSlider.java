...
public class VibratoPhaseSlider extends JSlider {
	
	public static final int MULTIPLIER = 10000;
	
	public VibratoPhaseSlider(JLabel sliderValLabel, SineWave wave) {
		...
		this.addChangeListener(new ChangeListener() {
			...
			public void stateChanged(ChangeEvent e) {
				double val = ((VibratoPhaseSlider)e.getSource()).getValue() * 1.0 / MULTIPLIER;
				sliderValLabel.setText(String.valueOf(val));
				wave.setVibratoPhase(val);
				wave.calcSineVals();
			}
